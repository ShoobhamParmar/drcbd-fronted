...
import cbd1 from "../../../assets/blog/cbd-1.png";
  ...
  return (
    <div className="center">
      ...
      <div className="flex" style={{ width: "100%" }}>
        ...
        >
          <img src={cbd} alt="/" className="blog-img" loading="lazy"/>
          <button
            style={{
              maxWidth: "150px",
              width: "100%",
      ...
      >
        <img src={ce3} alt="/" className="image-style" loading="lazy"/>
        <img
          src={ce4}
          alt="/"
          ...
          loading="lazy"
        />
        <img src={ce5} alt="/" className="image-style" loading="lazy"/>
      </div>
      <div
        className="flex"
        style={{
